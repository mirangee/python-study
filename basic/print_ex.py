...
'''
print(dog, cat, '좋아요', sep=' ') # 이것이 print 함수의 기본값
print(dog, cat, '좋아요', sep='') # 공백을 없애고 싶다면 이렇게
print(dog, cat, '좋아요', sep='랑') # 원하는 문자열을 넣을 수 있다.
...
print(dog, cat, '좋아요', end='!!!') # 이렇게 설정하면 줄 개행 없이 마지막에 !!!이 붙는다.
print('이 문장은 줄 개행이 되어서 나올까?')
print(dog, cat, '좋아요', end='!!!\n')


# sep과 end를 순서 상관없이 같이 쓸 수 있다.
print(dog, cat, '좋아요~', end=' ', sep='->') 
print('줄 개행 안 되지요~ 야호~')

# 단, 출력할 내용이 먼저 전달되어야 한다!
