...
apple = 3
print('사과가 ', apple, '개 있습니다.', sep='') # sep을 따로 써야해서 조금 귀찮음
print('사과가 %d개 있습니다.' % apple)

'''
여러개의 데이터도 하나의 문자열에 포맷팅할 수 있는데,
...
# 마치 JavaScript의 리터럴 템플릿 같은 효과
print(f'{month}월 {day}일은 {anni}입니다')

# {} 안에서는 수식도 사용이 가능합니다.
salary = 300
print(f'보너스를 합한 월급은 {salary + 100}입니다.')

print(f'원주율은 {pi:0.3f}입니다')