...
# 리스트와 동일하게 튜플로 가능한 문법 (내부 요소값을 바꾸지 않는 행위)
print(tu[2])
print(tu[1:3]) # 원본은 그대로 있고 새로운 tuple이 반환된다.
print(tu + (10, 11)) # 원본은 그대로 있고 새로운 tuple이 반환된다. -> (1, 3, 5, 7, 9, 10, 11)
print(tu * 2) # 원본은 그대로 있고 새로운 tuple이 반환된다. -> (1, 3, 5, 7, 9, 1, 3, 5, 7, 9)
...
p = [2, 3, 4, 5, 6]
p = tuple(p) # -> 튜플로 변환
# p[3] = 6 튜플이기 때문에 값 변경 불가

p = list(p)

p[3] = 100
p.append(17)
print(p) # [2, 3, 4, 100, 6, 17]